...
class AnimatedActivity extends StatefulWidget {
  ...
  const AnimatedActivity({Key? key, this.duration, this.size, this.callback})
      : super(key: key);

  @override
  _AnimatedActivityState createState() => _AnimatedActivityState();
}

class _AnimatedActivityState extends State<AnimatedActivity>
