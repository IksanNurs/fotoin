...
String UrlBase = 'http://domaintesting.my.id';
const colorizeColors = [
  Colors.white,
  Color.fromARGB(255, 37, 170, 226),
  Color.fromARGB(255, 106, 185, 217)
];
const colorizeColors1 = [
  Colors.white,
  Color.fromARGB(255, 43, 182, 115),
  Color.fromARGB(255, 106, 185, 217)
];
...
Color bgColor1 = Color.fromARGB(255, 106, 185, 217);
